### The step-by-step procedure for installing Red Hat Enterprise Linux 9.0 on virtual machine that will serve as storage node in a Pacemaker/Corosync high-availability cluster.
...
```text
       ...
       └────────┘          └────────┘          └────────┘          └─────────┘
          │                   │                   │                   │
          │                   │                   │                   │
 192.168.237.128      192.168.237.129      192.168.237.131      192.168.237.130
```
