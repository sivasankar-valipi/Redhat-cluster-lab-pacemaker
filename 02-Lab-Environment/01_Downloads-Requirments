...
In this project, VMware Workstation Pro 26H1 is used to build a Red Hat High Availability (HA) Cluster by creating multiple Red Hat Enterprise Linux virtual machines.
...
After downloading VMware Workstation Pro and the RHEL DVD ISO, proceed to **VMware Workstation Installation** to create the virtual machines for the Red Hat High Availability (HA) Cluster lab.
